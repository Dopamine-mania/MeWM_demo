...
def get_loader(args):
    ...
    for item in args.dataset_list:
        ...
        # for line in open(args.data_txt_path + item +'_train_debug.txt'):
            name = line.strip().split()[1].split('.')[0] # 10_Decathlon/Task03_Liver/labelsTr/liver_0
    ...
    val_name = []
    for item in args.dataset_list:
        for line in open(args.data_txt_path + item +'_val_healthy_debug.txt'):
    ...
    if args.phase == 'test':
        ...
        return test_loader, val_transforms, len(test_dataset)
        # return test_loader
